...
class View {
    static initialPage() {
        ...
        container.innerHTML =
        `
        <div class="vh-100 d-flex justify-content-center align-items-center bg-beige ">
            <div class="d-flex align-items-center justify-content-center col-md-6 col-8">
                <div class="bg-lightGray text-center p-4 radius-5per">
    ...
    static mainPage(user) {
        ...
        container.innerHTML =
        `
            <div class="d-flex justify-content-center px-md-5 py-md-1 bg-beige" style="height: 100vh;">
                <div class="border border-dark border-width-2px bg-white p-2 d-flex col-md-9 col-lg-6">
                    <div id="tieStatus" class="border border-dark border-width-2px p-2 col-4 bg-white ">

                    </div>
                    <div class="col-8 d-flex flex-column">
                        <div id="userInfo" class="p-1 border border-dark border-width-2px">

                        </div>
                        <div id="displayItems" class=" mt-2 p-1 overflowAuto flowHeight border border-dark border-width-2px bg-gray">
    ...
    static makeTieStatus(user) {
        let container = document.createElement("div");
        container.className = 'd-flex flex-column justify-content-around h-100per'

        container.innerHTML =
        `
            <div class="border border-dark border-width-2px py-2 mx-2 text-center">
                <h3>${user.clickCount} Ties</h3>
                <h5>one click Net income ¥${user.incomePerClick}</h5>
            </div>
            <div class="d-flex justify-content-center" >
                <img src="https://user-images.githubusercontent.com/75964449/207304772-3902a931-9e88-4b06-aac4-50b79af67086.png" alt=""  class="col-12 hover imgFit" id="jacket">
            </div>
        `
    ...
    static makeUserInfo(user) {
        let container = document.createElement("div");
        container.classList.add("d-flex", "flex-wrap", "p-1", "justify-content-around", "mb-1");
    ...
    static makeDisplayItems(user) {
        ...
        for (let i = 0; i < user.goodsObjList.length; i++) {
            ...
            div.classList.add("text-lightGray", "d-sm-flex", "align-items-center", "m-2", "bg-dark", "hover", "hover-border", "radius-5per", "shadow-lg");
    ...
    static makePurchasePage(user, index) {
        ...
        container.innerHTML =
        `
            <div class="bg-dark px-2 pt-2 m-1 text-lightGray overflowAuto">
